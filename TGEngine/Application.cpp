...
void createApplication(APP::Application app) {
	...
	handel(glfwCreateWindowSurface(*app.instance, WINDOW::window.window, nullptr, app.KHR));
}

void destroyApplictaion(APP::Application app) {
